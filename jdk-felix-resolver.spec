...
License  : Apache-2.0
Requires: jdk-felix-resolver-data
...
%package data
Summary: data components for the jdk-felix-resolver package.
Group: Data

%description data
data components for the jdk-felix-resolver package.


%prep
%setup -q -n felix-org.apache.felix.resolver-1.8.0

python3 /usr/share/java-utils/pom_editor.py pom_change_dep    org.osgi:org.osgi.core org.apache.felix:org.apache.felix.framework

%build
python3 /usr/share/java-utils/mvn_build.py

%install
xmvn-install  -R .xmvn-reactor -n felix-resolver -d %{buildroot}
...
%files data
%defattr(-,root,root,-)
/usr/share/java/felix-resolver/org.apache.felix.resolver.jar
/usr/share/maven-metadata/felix-resolver.xml
/usr/share/maven-poms/felix-resolver/org.apache.felix.resolver.pom
